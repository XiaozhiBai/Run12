...
StSingle_electron_EventCount::StSingle_electron_EventCount()
{
}
...
Int_t StSingle_electron_EventCount::GetEntry(Long64_t entry)
{
...
Int_t StSingle_electron_EventCount::GetEntries()
{
    if(fChain)return fChain->GetEntriesFast();
    return 0;
}

void StSingle_electron_EventCount::Init(TTree *tree)
{
