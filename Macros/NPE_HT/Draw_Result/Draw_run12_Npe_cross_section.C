...
char buf[1024];
void Draw_run12_Npe_cross_section()

{
  ...
  cout<< sizeof(pt_arr_AuAu)/sizeof(pt_arr_AuAu[0]);
  ...
  gFONLLu->SetLineStyle(7);
  gFONLLc->SetLineStyle(7);
  gFONLLl->SetLineStyle(7);

  gFONLLu->SetLineWidth(1);
  gFONLLc->SetLineWidth(1.5);
  gFONLLl->SetLineWidth(1);

  gFONLLu->SetLineColor(1);
  gFONLLc->SetLineColor(1);
  gFONLLl->SetLineColor(1);
...
//   return;
  ...
  gR_FONLLl->SetLineColor(1);
   ...
   //--------------------------run08--------------------------------------------
   TFile *Run08_data_fonll=new TFile("Run08_data_fonll.root","READ");
   TGraphErrors *Graph_from_run08_sts_ratio=(TGraphErrors *) Run08_data_fonll->Get("Graph_from_run08_sts_ratio");
   TGraphErrors *Graph_from_run08_sys_ratio=(TGraphErrors *) Run08_data_fonll->Get("Graph_from_run08_sys_ratio");
   Graph_from_run08_sts_ratio->SetMarkerSize(1);
   Graph_from_run08_sys_ratio->SetMarkerSize(1);

   Graph_from_run08_sts_ratio->SetMarkerStyle(gMStyle08);
   Graph_from_run08_sys_ratio->SetMarkerStyle(gMStyle08);


   Graph_from_run08_sts_ratio->SetMarkerColor(gColor08);
   Graph_from_run08_sys_ratio->SetMarkerColor(gColor08);

   Graph_from_run08_sts_ratio->SetLineColor(gColor08);
   Graph_from_run08_sys_ratio->SetLineColor(gColor08);

   Graph_from_run08_sys_ratio->SetLineWidth(1);

   for(Int_t ipt=0;ipt<9;ipt++)
   {
     //dddd
     Graph_from_run08_sts_ratio->SetPointError(ipt,0,Graph_from_run08_sts_ratio->GetErrorY(ipt));
     Graph_from_run08_sys_ratio->SetPointError(ipt,0.12,Graph_from_run08_sys_ratio->GetErrorY(ipt));



   }
   Graph_from_run08_sys_ratio->SetFillStyle(3001);
   Graph_from_run08_sys_ratio->SetFillColor(gColor08_fill);
